...
export class CsvConverter {
  ...
  static csvToPdf(csvText, options = {}) {
    ...
    if (rawRows.length === 0) {
      builder.addHeading(options.title || 'CSV Data Export', 1, { fontSize: 18 });
      return builder.save();
    }

    builder.addHeading(options.title || 'Tabular Data Report', 1, { fontSize: 20, align: 'center', color: '#003366' });
